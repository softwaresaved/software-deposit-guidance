...
| **Guide** | **Zenodo DOI suffixes**** 10.5281/<suffix> **|** Researchers **|** Principal Investigators **|** Research Data Managers** |
| --- | --- | --- | --- | --- |
| Why deposit software | zenodo.TODO | ✓ | ✓ |   |
| When to deposit software | zenodo.TODO | ✓ | ✓ |   |
| Where to deposit software | zenodo.TODO | ✓ | ✓ |   |
| How to deposit software | zenodo.TODO | ✓ |   |   |
| What to deposit | zenodo.TODO | ✓ |   | ✓ |
| What not to deposit | zenodo.TODO | ✓ |   | ✓ |
| How to describe a software deposit | zenodo.TODO | ✓ |   | ✓ |
| How to choose a software licence | zenodo.TODO | ✓ | ✓ |   |
| How to review a software deposit | zenodo.TODO | ✓ |   | ✓ |
...
**Key points from Why deposit software**
...
**Key points from When to deposit software**
...
**Key points from Where to deposit software**
...
**Key points from How to deposit software**
...
**Key points from What to deposit**
...
**Key points from What not to deposit**
...
**Key points from How to describe a software deposit**
...
**Key points from How to choose a software licence**
...
**Key points from How to review a software deposit**
...
**Digital repository** : a repository, archive or service that hosts digital artefacts, including research outputs such as papers, presentations, data sets and software. For example, Zenodo [6], figshare [7], DSpace [8] or Samvera
...
**Repository hosting service** : a service that hosts source code repositories within an institution, within a community, or for myriad individuals and communities. For example, GitHub

#
[10], BitBucket [11], GitLab
#
 [12], CCPForge
#
[13] or Microsoft Visual Studio Team Services [14].
