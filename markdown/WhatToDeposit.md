...
BY 'Daniel S. Katz'
ON '2018-06-04T17:42:09'
NOTE: 'A lot of the material in here is highly valuable, but may not be part of what is deposited.  For example, when documentation is provided via a website, should a copy of the website contents or the source used to build the website be part of what is deposited?  Alternatively, maybe a link to the pages is archive.org would be sufficient.']
User documentation
...
BY 'Fernando Rios'
ON '2018-07-10T17:18:31'
NOTE: 'I would also be interested in the group's position on this.'
NOTE: ''
NOTE: 'Here's something related to chew on (explaining this is always hard). '
NOTE: ''
NOTE: 'People have different ideas of what research software is. The definition of research software in the glossary includes software that "is used" in a research context. The question is what to deposit/preserve? Should I try preserve the copy of Python/SPSS/ArcGIS/whatever? Probably not but I think it could be made clearer. '
NOTE: ''
NOTE: 'Overall, the language and tone used in the entire set of guides is oriented toward scientific software. This is ok but the intended audience could be made clearer (i.e., these guides are not written for disciplines which do not have strong computational traditions)']

#
[ANNOTATION:

BY 'Steve Jones'
ON '2018-06-08T09:02:41'
NOTE: 'Does the group have a position on long-term availability of dependencies? It's obviously outside the scope of what we can expect users of this guide to do, but the question will come up so it would be good to have a statement of some kind. (Even if it's just to say that we are deliberately not addressing the issue.)']
...
For more information, see our guide on "Software Deposit:
#
[ANNOTATION:

BY 'Daniel S. Katz'
ON '2018-06-04T17:47:27'
NOTE: 'add link']
