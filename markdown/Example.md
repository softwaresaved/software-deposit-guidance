...
* Michael Jackson (ed.) (%DATE%). Software Deposit: Why deposit software (Version %VERSION%). Zenodo. doi:[%WHY_DOI%](https://doi.org/%WHY_DOI%). Online: [%DISPLAY_URL%/WhyDepositSoftware.html](%LINK_URL%/WhyDepositSoftware.html).
* Michael Jackson (ed.) (%DATE%). Software Deposit: When to deposit software (Version %VERSION%). Zenodo. doi:[%WHEN_DOI%](https://doi.org/%WHEN_DOI%). Online: [%DISPLAY_URL%/WhenToDepositSoftware.html](%LINK_URL%/WhenToDepositSoftware.html).
* Michael Jackson (ed.) (%DATE%). Software Deposit: Where to deposit software (Version %VERSION%). Zenodo. doi:[%WHERE_DOI%](https://doi.org/%WHERE_DOI%). Online: [%DISPLAY_URL%/WhereToDepositSoftware.html](%LINK_URL%/WhereToDepositSoftware.html).
* Michael Jackson (ed.) (%DATE%). Software Deposit: How to deposit software (Version %VERSION%). Zenodo. doi:[%HOW_DOI%](https://doi.org/%HOW_DOI%). Online: [%DISPLAY_URL%/HowToDepositSoftware.html](%LINK_URL%/HowToDepositSoftware.html).
